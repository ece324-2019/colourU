...
class Window(Frame):
    ...
    def init_window(self):
        ...
        # Import Model
        self.model = torch.load("Generator_Model.pt", map_location=torch.device('cpu'))  # change to load new GAN Model
        self.model2 = torch.load("baseline.pt", map_location=torch.device('cpu'))  # change to load new baseline model
