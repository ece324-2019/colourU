...
def train(image_path, num_images, num_epochs, error_scaler=0.5, training_scaler=1, fresh_start = True,
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(g_steps):
            for data in train_loader:
                ...
                g_error = g_error_1 + error_scaler * g_error_2
                g_error.backward()
